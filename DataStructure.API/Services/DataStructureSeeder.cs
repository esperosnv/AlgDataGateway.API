    ...
    public class DataStructureSeeder : IDataStructureSeeder
    {
        ...
        public List<DataStructureClass> getDataStructureList()
        {
            ...
            DataStructureClass stack = new DataStructureClass(
                ...
                " Stack is useful when we need quick access to only the latest added element. Its disadvantage is slow access to other elements.",
                "AVERAGE TIME COMPLEXITY for operations Push, Pop is O(1), Search is O(n).");
            ...
            DataStructureClass hashTable = new DataStructureClass(
                ...
                " The disadvantage is that hash table cannot store the same elements. Also, it is slow when the so called key collision occurs.",
